...
# Open a png file to plot the histogram.
   ...
   plot(dateTime, dataForPeriodOfInterest$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
   ...
   plot(dateTime, dataForPeriodOfInterest$Global_reactive_power, type = "l", xlab = "datetime", ylab = colNames[4])
